                ...
                <fieldset className="p-0 m-0 border-0 min-w-0 leading-[1.5rem] font-light text-[14px] text-black-lacquer">
                  <li className="w-[21.67%] m-[1%] inline-block align-top list-none">
                    <input
                      ...
                      value="36"
                      checked="checked"
                      className="checked:bg-cerebral-grey checked:border-baby-talk-grey opacity-0 w-0 h-0 hidden text-[17px] font-medium leading-[1em] px-[0.75em] py-0 m-0 border-0 rounded-[2px]"
                    />
                    <label for="amount_36" 
                    className="text-[13px] leading-[20px] font-medium float-none my-[0.5em] mx-0 cursor-pointer relative w-auto hover:bg-cerebral-grey hover:border-baby-talk-grey  bg-super-silver border-[1px] border-solid border-christmas-silver  py-[10px] px-0 block text-black-out text-center h-auto left-[0px] rounded-[3px] max-w-full">
                  ...
                  <li className="w-[21.67%] m-[1%] inline-block align-top list-none">
                    ...
                    />
                    <label for="amount_72"
                    className="text-[13px] leading-[20px] font-medium float-none my-[0.5em] mx-0 cursor-pointer relative w-auto hover:bg-cerebral-grey hover:border-baby-talk-grey bg-super-silver border-[1px] border-solid border-christmas-silver py-[10px] px-0 block text-super-silver text-center h-auto left-[0px] rounded-[3px] max-w-full">
                ...
                <ul className="ml-0 pl-0 mt-0 mb-[10px] ">
                  <fieldset className="p-0 m-0 border-0 min-w-0 ">
                    <li className="inline-block align-top w-[47.1%] m-[1%]">
                      ...
                      />
                      <label className="text-[13px] leading-[20px] font-medium float-none my-[0.5em] mx-0 cursor-pointer w-auto border-[1px] border-solid hover:border-baby-talk-grey hover:bg-cerebral-grey bg-super-silver border-christmas-silver py-[10px] px-0 block text-black-out text-center h-auto left-[0px] rounded-[3px] max-w-full" for="frequency_One_Time_Donation">
                    ...
                    <li className="inline-block align-top w-[47.1%] m-[1%]">
                      <input
                        ...
                        className="opacity-0 w-0 h-0 hidden text-[17px] font-medium leading-[1em] px-[0.75em] py-0 m-0 border-0 rounded-[2px]"
                      />
                      <label className="text-[13px] leading-[20px] font-medium float-none my-[0.5em] mx-0 cursor-pointer w-auto border-[1px] hover:border-baby-talk-grey hover:bg-cerebral-grey border-solid border-christmas-silver bg-super-silver py-[10px] px-0 block text-black-out text-center h-auto left-[0px] rounded-[3px] max-w-full" for="frequency_36">
